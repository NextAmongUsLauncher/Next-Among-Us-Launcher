...
)
{
    ...
    [JsonPropertyOrder(1)] public string Name { get; set; } = name;

    [JsonPropertyOrder(2)] public string PingServer { get; set; } = pingServer;

    [JsonPropertyName("Servers")]
    [JsonPropertyOrder(3)]
    public List<ServerInfo> ServerInfos { get; set; } = serverInfos;

    [JsonPropertyOrder(4)] public string? TargetServer { get; set; } = targetServer;

    [JsonPropertyOrder(4)] public int TranslateName { get; set; } = translateName;
